package net.uk.onetransport.android.test.onetransporttest.tests.northants.trafficscoot;
...
import net.uk.onetransport.android.county.northants.trafficscoot.TrafficScootRetrieverLoader;
import net.uk.onetransport.android.test.onetransporttest.RunnerFragment;
import net.uk.onetransport.android.test.onetransporttest.RunnerTask;
import net.uk.onetransport.android.test.onetransporttest.tests.OneTransportTest;

public class NorthantsTrafficScootRetrieveTest extends OneTransportTest
    ...
    public void startAsync(DougalCallback dougalCallback) {
        ((RunnerFragment) dougalCallback).setCurrentTest("NORTHANTS get traffic scoot array");
    ...
    public void onLoadFinished(Loader<RetrieverResult<TrafficScoot>> loader,
        ...
        if (data.getExceptions().size() > 0 || data.getContent() == null) {
            dougalCallback.getResponse(null, new Throwable("NORTHANTS traffic scoot array error"));
        } else {
    ...
    private void getTrafficScootArray(RunnerTask runnerTask) throws Exception {
        runnerTask.setCurrentTest("NORTHANTS get traffic scoot array");
        TrafficScoot[] trafficScoots = new TrafficScootRetriever(getContext()).retrieve();
        if (trafficScoots == null || trafficScoots.length == 0) {
            runnerTask.report("NORTHANTS get traffic scoot array ... FAILED.", COLOUR_FAILED);
        } else {
            runnerTask.report("NORTHANTS get traffic scoot array ... PASSED.", COLOUR_PASSED);
        }
    }
}