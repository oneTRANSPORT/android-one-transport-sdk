 ...
 */
package net.uk.onetransport.android.test.onetransporttest.tests.oxon.carpark;
...
import net.uk.onetransport.android.county.oxon.carparks.CarParkRetrieverLoader;
import net.uk.onetransport.android.county.oxon.generic.RetrieverResult;
import net.uk.onetransport.android.test.onetransporttest.RunnerFragment;
import net.uk.onetransport.android.test.onetransporttest.RunnerTask;
import net.uk.onetransport.android.test.onetransporttest.tests.OneTransportTest;

public class OxonCarParkRetrieveTest extends OneTransportTest
    ...
    public void startAsync(DougalCallback dougalCallback) {
        ((RunnerFragment) dougalCallback).setCurrentTest("OXON get car park array");
    ...
    public void onLoadFinished(Loader<RetrieverResult<CarPark>> loader, RetrieverResult<CarPark> data) {
        if (data.getExceptions().size() > 0 || data.getContent() == null) {
            dougalCallback.getResponse(null, new Throwable("OXON car park array error"));
        } else {
    ...
    private void getCarParkArray(RunnerTask runnerTask) throws Exception {
        runnerTask.setCurrentTest("OXON get car park array");
        CarPark[] carParks = new CarParkRetriever(getContext()).retrieve();
        if (carParks == null || carParks.length == 0) {
            Log.i("OxonCarPark", "Error no data in feed");
            runnerTask.report("OXON get car park array ... FAILED.", COLOUR_FAILED);
        } else {
            runnerTask.report("OXON get car park array ... PASSED.", COLOUR_PASSED);
        }
    }
}
