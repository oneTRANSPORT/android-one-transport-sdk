 ...
 */
package net.uk.onetransport.android.test.onetransporttest.tests.bucks.trafficspeed;
...
import net.uk.onetransport.android.county.bucks.trafficspeed.TrafficSpeedRetrieverLoader;
import net.uk.onetransport.android.test.onetransporttest.RunnerFragment;
import net.uk.onetransport.android.test.onetransporttest.RunnerTask;
import net.uk.onetransport.android.test.onetransporttest.tests.OneTransportTest;

public class BucksTrafficSpeedRetrieveTest extends OneTransportTest
    ...
    public void startAsync(DougalCallback dougalCallback) {
        ((RunnerFragment) dougalCallback).setCurrentTest("BUCKS get traffic speed array");
    ...
    public void onLoadFinished(Loader<RetrieverResult<TrafficSpeed>> loader,
        ...
        if (data.getExceptions().size() > 0 || data.getContent() == null) {
            dougalCallback.getResponse(null, new Throwable("Bucks traffic speed array error"));
        } else {
    ...
    private void getTrafficSpeedArray(RunnerTask runnerTask) throws Exception {
        runnerTask.setCurrentTest("BUCKS get traffic speed array");
        TrafficSpeed[] trafficSpeeds = new TrafficSpeedRetriever(getContext()).retrieve();
        if (trafficSpeeds == null || trafficSpeeds.length == 0) {
            Log.i("BucksTrafficSpeed", "Error no data in feed");
            runnerTask.report("BUCKS get traffic speed array ... FAILED.", COLOUR_FAILED);
        } else {
            runnerTask.report("BUCKS get traffic speed array ... PASSED.", COLOUR_PASSED);
        }
    }
}
