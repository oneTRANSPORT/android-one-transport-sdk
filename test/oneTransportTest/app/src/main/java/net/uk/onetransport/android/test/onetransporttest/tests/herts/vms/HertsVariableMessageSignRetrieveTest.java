 ...
 */
package net.uk.onetransport.android.test.onetransporttest.tests.herts.vms;
...
import net.uk.onetransport.android.county.herts.variablemessagesigns.VariableMessageSignRetrieverLoader;
import net.uk.onetransport.android.test.onetransporttest.RunnerFragment;
import net.uk.onetransport.android.test.onetransporttest.RunnerTask;
import net.uk.onetransport.android.test.onetransporttest.tests.OneTransportTest;

public class HertsVariableMessageSignRetrieveTest extends OneTransportTest
    ...
    public void startAsync(DougalCallback dougalCallback) {
        ((RunnerFragment) dougalCallback).setCurrentTest("HERTS get VMS array");
    ...
    public void onLoadFinished(Loader<RetrieverResult<VariableMessageSign>> loader,
        ...
        if (data.getExceptions().size() > 0 || data.getContent() == null) {
            dougalCallback.getResponse(null, new Throwable("HERTS VMS array error"));
        } else {
    ...
    private void getVariableMessageSignArray(RunnerTask runnerTask) throws Exception {
        runnerTask.setCurrentTest("HERTS get VMS array");
        ...
        if (variableMessageSigns == null || variableMessageSigns.length == 0) {
            Log.i("HertsVMS", "Error no data in feed");
            runnerTask.report("HERTS get VMS array ... FAILED.", COLOUR_FAILED);
        } else {
            runnerTask.report("HERTS get VMS array ... PASSED.", COLOUR_PASSED);
        }
    }
}
