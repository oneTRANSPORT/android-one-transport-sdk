 ...
 */
package net.uk.onetransport.android.test.onetransporttest.tests.oxon.vms;
...
import net.uk.onetransport.android.county.oxon.variablemessagesigns.VariableMessageSignRetrieverLoader;
import net.uk.onetransport.android.test.onetransporttest.RunnerFragment;
import net.uk.onetransport.android.test.onetransporttest.RunnerTask;
import net.uk.onetransport.android.test.onetransporttest.tests.OneTransportTest;

public class OxonVariableMessageSignRetrieveTest extends OneTransportTest
    ...
    public void startAsync(DougalCallback dougalCallback) {
        ((RunnerFragment) dougalCallback).setCurrentTest("OXON get VMS array");
    ...
    public void onLoadFinished(Loader<RetrieverResult<VariableMessageSign>> loader,
        ...
        if (data.getExceptions().size() > 0 || data.getContent() == null) {
            dougalCallback.getResponse(null, new Throwable("OXON VMS array error"));
        } else {
    ...
    private void getVariableMessageSignArray(RunnerTask runnerTask) throws Exception {
        runnerTask.setCurrentTest("OXON get VMS array");
        ...
        if (variableMessageSigns == null || variableMessageSigns.length == 0) {
            Log.i("OxonVMS", "Error no data in feed");
            runnerTask.report("OXON get VMS array ... FAILED.", COLOUR_FAILED);
        } else {
            runnerTask.report("OXON get VMS array ... PASSED.", COLOUR_PASSED);
        }
    }
}
