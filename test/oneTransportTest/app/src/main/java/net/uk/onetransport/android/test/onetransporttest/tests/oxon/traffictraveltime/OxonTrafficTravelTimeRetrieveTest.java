 ...
 */
package net.uk.onetransport.android.test.onetransporttest.tests.oxon.traffictraveltime;
...
import net.uk.onetransport.android.county.oxon.traffictraveltime.TrafficTravelTimeRetrieverLoader;
import net.uk.onetransport.android.test.onetransporttest.RunnerFragment;
import net.uk.onetransport.android.test.onetransporttest.RunnerTask;
import net.uk.onetransport.android.test.onetransporttest.tests.OneTransportTest;

public class OxonTrafficTravelTimeRetrieveTest extends OneTransportTest
    ...
    public void startAsync(DougalCallback dougalCallback) {
        ((RunnerFragment) dougalCallback).setCurrentTest("OXON get traffic travel time array");
    ...
    public void onLoadFinished(Loader<RetrieverResult<TrafficTravelTime>> loader,
        ...
        if (data.getExceptions().size() > 0 || data.getContent() == null) {
            dougalCallback.getResponse(null, new Throwable("OXON traffic travel time array error"));
        } else {
    ...
    private void getTrafficTravelTimeArray(RunnerTask runnerTask) throws Exception {
        runnerTask.setCurrentTest("OXON get traffic travel time array");
        ...
        if (trafficTravelTimes == null || trafficTravelTimes.length == 0) {
            Log.i("OxonTrafficTravelTime", "Error no data in feed");
            runnerTask.report("OXON get traffic travel time array ... FAILED.", COLOUR_FAILED);
        } else {
            runnerTask.report("OXON get traffic travel time array ... PASSED.", COLOUR_PASSED);
        }
    }
}
