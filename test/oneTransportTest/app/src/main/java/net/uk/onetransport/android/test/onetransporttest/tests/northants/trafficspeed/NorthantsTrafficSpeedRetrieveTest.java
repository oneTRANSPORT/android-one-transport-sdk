package net.uk.onetransport.android.test.onetransporttest.tests.northants.trafficspeed;
...
import net.uk.onetransport.android.county.northants.trafficspeed.TrafficSpeedRetrieverLoader;
import net.uk.onetransport.android.test.onetransporttest.RunnerFragment;
import net.uk.onetransport.android.test.onetransporttest.RunnerTask;
import net.uk.onetransport.android.test.onetransporttest.tests.OneTransportTest;

public class NorthantsTrafficSpeedRetrieveTest extends OneTransportTest
    ...
    public void startAsync(DougalCallback dougalCallback) {
        ((RunnerFragment) dougalCallback).setCurrentTest("NORTHANTS get traffic speed array");
    ...
    public void onLoadFinished(Loader<RetrieverResult<TrafficSpeed>> loader,
        ...
        if (data.getExceptions().size() > 0 || data.getContent() == null) {
            dougalCallback.getResponse(null, new Throwable("NORTHANTS traffic speed array error"));
        } else {
    ...
    private void getTrafficSpeedArray(RunnerTask runnerTask) throws Exception {
        runnerTask.setCurrentTest("NORTHANTS get traffic speed array");
        TrafficSpeed[] trafficSpeeds = new TrafficSpeedRetriever(getContext()).retrieve();
        if (trafficSpeeds == null || trafficSpeeds.length == 0) {
            runnerTask.report("NORTHANTS get traffic speed array ... FAILED.", COLOUR_FAILED);
        } else {
            runnerTask.report("NORTHANTS get traffic speed array ... PASSED.", COLOUR_PASSED);
        }
    }
}
