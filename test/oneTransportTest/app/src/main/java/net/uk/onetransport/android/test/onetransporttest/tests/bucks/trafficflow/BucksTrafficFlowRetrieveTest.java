...
import net.uk.onetransport.android.county.bucks.trafficflow.TrafficFlowRetrieverLoader;
import net.uk.onetransport.android.test.onetransporttest.RunnerFragment;
import net.uk.onetransport.android.test.onetransporttest.RunnerTask;
import net.uk.onetransport.android.test.onetransporttest.tests.OneTransportTest;

public class BucksTrafficFlowRetrieveTest extends OneTransportTest
    ...
    public void onLoadFinished(Loader<RetrieverResult<TrafficFlow>> loader,
        ...
        if (data.getExceptions().size() > 0 || data.getContent() == null) {
            dougalCallback.getResponse(null, new Throwable("Bucks traffic flow array error"));
        } else {
    ...
    private void getTrafficFlowArray(RunnerTask runnerTask) throws Exception {
        ...
        if (trafficFlows == null || trafficFlows.length == 0) {
            Log.i("BucksTrafficFlow", "Error no data in feed");
