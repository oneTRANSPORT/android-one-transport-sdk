 ...
 */
package net.uk.onetransport.android.test.onetransporttest.tests.herts.traffictraveltime;
...
import net.uk.onetransport.android.county.herts.traffictraveltime.TrafficTravelTimeRetrieverLoader;
import net.uk.onetransport.android.test.onetransporttest.RunnerFragment;
import net.uk.onetransport.android.test.onetransporttest.RunnerTask;
import net.uk.onetransport.android.test.onetransporttest.tests.OneTransportTest;

public class HertsTrafficTravelTimeRetrieveTest extends OneTransportTest
    ...
    public void startAsync(DougalCallback dougalCallback) {
        ((RunnerFragment) dougalCallback).setCurrentTest("HERTS get traffic travel time array");
    ...
    public void onLoadFinished(Loader<RetrieverResult<TrafficTravelTime>> loader,
        ...
        if (data.getExceptions().size() > 0 || data.getContent() == null) {
            dougalCallback.getResponse(null, new Throwable("HERTS traffic travel time array error"));
        } else {
    ...
    private void getTrafficTravelTimeArray(RunnerTask runnerTask) throws Exception {
        runnerTask.setCurrentTest("HERTS get traffic travel time array");
        ...
        if (trafficTravelTimes == null || trafficTravelTimes.length == 0) {
            Log.i("HertsTrafficTravelTime", "Error no data in feed");
            runnerTask.report("HERTS get traffic travel time array ... FAILED.", COLOUR_FAILED);
        } else {
            runnerTask.report("HERTS get traffic travel time array ... PASSED.", COLOUR_PASSED);
        }
    }
}
