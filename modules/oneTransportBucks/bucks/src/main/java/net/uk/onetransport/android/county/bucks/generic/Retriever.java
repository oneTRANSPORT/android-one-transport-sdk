 ...
 */
package net.uk.onetransport.android.county.bucks.generic;
...
public abstract class Retriever<T> {
    ...
    public T[] retrieve() throws Exception {
        ...
        String cseBaseUrl = context.getString(R.string.bucks_base_url)
                + context.getString(R.string.bucks_cse_name) + File.separator;
