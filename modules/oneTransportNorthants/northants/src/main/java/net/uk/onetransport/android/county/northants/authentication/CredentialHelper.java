 ...
 */
package net.uk.onetransport.android.county.northants.authentication;
...
import net.uk.onetransport.android.county.northants.storage.Prefs;
...
public class CredentialHelper {
    ...
    public synchronized static void initialiseCredentials(Context context, String aeId, String sessionToken,
        ...
        Resource.addInterceptors(context.getString(R.string.northants_cse_base_url),
